...
function jSignatureClass(parent, options, instanceExtensions) {
	...
	, settings = {
		'width' : 'ratio'
		,'height' : 'ratio'
		,'sizeRatio': 2 // 4 only used when height = 'ratio'
		,'color' : '#000'
	...
	settings.lineWidth = (function(defaultLineWidth, canvasWidth){
		if (!defaultLineWidth){
			return Math.max(
				Math.round(canvasWidth / 800) /*+1 pixel for every extra 300px of width.*/
				, 2 /* minimum line width */
			) 
//	harris						Math.round(canvasWidth / 400) /*+1 pixel for every extra 300px of width.*/
			//				, 2 /* minimum line width */
		} else {
	...
	var movementHandlers = (function(jSignatureInstance) {
		...
		this.drawStartHandler = function(e) {
			...
			//console.log('jsx: '+getPointFromEvent(e).x,'jsy: '+getPointFromEvent(e).y)
			c.push({x:getPointFromEvent(e).x,y:getPointFromEvent(e).y})
			timer.kick()
		}
...
//harris	ctx.lineWidth = Math.ceil(parseInt(settings.lineWidth, 10))
